...
const Homepage = () => {
  ...
  <Col xs={24} md={12} className="w-full md:w-1/2 flex justify-center">
    <Statistic
      className="bg-white w-full max-w-sm p-4 rounded-lg shadow-md"
      title={
        <span>
          <FundOutlined
            style={{ marginRight: 8, color: "#1890ff", fontSize: "large" }}
          />
  ...
  <Col xs={24} md={12} className="w-full md:w-1/2 flex justify-center">
    <Statistic
      ...
      title={
        <span>
          <BankOutlined
            style={{ marginRight: 8, color: "#52c41a", fontSize: "large" }}
          />
          Total Exchanges
        </span>
      }
      ...
      title={
        <span>
          <MoneyCollectOutlined
            style={{ marginRight: 8, color: "#faad14", fontSize: "large" }}
          />
          Total Market Cap
        </span>
      }
      ...
      title={
        <span>
          <DollarCircleOutlined
            style={{ marginRight: 8, fontSize: "large", color: "#13c2c2" }}
          />
          Total 24h Volume
        </span>
      }
  ...
  <Col xs={24} md={12} className="w-full md:w-1/2 flex justify-center">
    <Statistic
      ...
      title={
        <span>
          <ShoppingOutlined
            style={{ marginRight: 8, color: "#722ed1", fontSize: "large" }}
          />
          Total Markets
        </span>
      }
